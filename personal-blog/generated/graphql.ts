...
export type BlogPostsBySlugQuery = {
    __typename?: 'Query';
    BlogPost?: {
        __typename?: 'BlogPostOutput';
        items?: Array<{
...
export type BlogPostByTagQuery = {
    __typename?: 'Query';
    BlogPost?: {
        __typename?: 'BlogPostOutput';
        items?: Array<{
...
export type BlogPostByDateQuery = {
    __typename?: 'Query';
    BlogPost?: {
        __typename?: 'BlogPostOutput';
        items?: Array<{
...
export function getSdk(
    ...
    return {
        ALlBlogPosts(
            variables?: ALlBlogPostsQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<ALlBlogPostsQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<ALlBlogPostsQuery>(
        ...
        BlogPostsBySlug(
            variables: BlogPostsBySlugQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<BlogPostsBySlugQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<BlogPostsBySlugQuery>(
                        BlogPostsBySlugDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
                'BlogPostsBySlug',
        ...
        BlogPostByTag(
            variables: BlogPostByTagQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<BlogPostByTagQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<BlogPostByTagQuery>(
                        BlogPostByTagDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
                'BlogPostByTag',
        ...
        BlogPostByDate(
            variables: BlogPostByDateQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<BlogPostByDateQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<BlogPostByDateQuery>(
                        BlogPostByDateDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
                'BlogPostByDate',
        ...
        PersonalBlog(
            variables?: PersonalBlogQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<PersonalBlogQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<PersonalBlogQuery>(
                        PersonalBlogDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
                'PersonalBlog',
